...
class MenusTableSeeder extends Seeder
{
    ...
    public function run()
    {
        DB::table('menus')->insert([
        	/** User **/
        	array('id' => 1, 'name'=>'Người dùng', 'link'=>'javascript:void(0)', 'parent_id'=>0,'icon'  => 'xe807'),
            array('id' => 2, 'name'=>'Danh sách', 'link'=>'admin/user', 'parent_id'=>1,'icon'  => ''),
            array('id' => 3, 'name'=>'Thêm mới', 'link'=>'admin/user/add', 'parent_id'=>1,'icon'  => ''),

        	/** Category **/
            array('id' => 4, 'name'=>'Loại sản phẩm', 'link'=>'javascript:void(0)', 'parent_id'=>0,'icon'  => 'xe808'),
            ...
            /** Product **/
            array('id' => 7, 'name'=>'Sản phẩm', 'link'=>'javascript:void(0)', 'parent_id'=>0,'icon'  => 'xe809'),
            ...
            /** Quản lý **/
            array('id' => 10, 'name'=>'Quản lý', 'link'=>'javascript:void(0)', 'parent_id'=>0,'icon'  => 'xe803'),
            ...
            /** Báo cáo **/
            array('id' => 14, 'name'=>'Báo cáo', 'link'=>'javascript:void(0)', 'parent_id'=>0,'icon'  => 'xe806'),
